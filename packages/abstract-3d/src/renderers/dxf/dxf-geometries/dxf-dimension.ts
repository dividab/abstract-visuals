...
export function dxfDimension(dimension: Dimension, parentPos: Vec3, parentRot: Vec3, sceneRotation: Vec3, handleRef: Handle): DxfDimensionDefinition {
  ...
  return dxfEncDimension(ms, me, lp, text, 7, sceneRotation, dimension.views ?? ["front"], handleRef);
}