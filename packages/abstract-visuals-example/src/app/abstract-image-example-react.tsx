...
import * as AbstractImage from "../../../abstract-image/src/index.js";
...
export function AbstractImageExampleReact(): React.JSX.Element {
  ...
  const components = [
    ...
    AbstractImage.createBinaryImage(AbstractImage.createPoint(0, 0), AbstractImage.createPoint(100, 100), "png", {
      type: "bytes",
      bytes: pngData,
    }),
