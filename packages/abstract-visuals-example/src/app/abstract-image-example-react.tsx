...
export function AbstractImageExampleReact(): React.JSX.Element {
  ...
  const subComponents = [createLine(createPoint(0, 0), createPoint(80, 60), red, 2, "subLine")];
  const subImage = createAbstractImage(createPoint(0, 0), createSize(400, 400), white, subComponents);
  const subSvg = createSVG(subImage);
