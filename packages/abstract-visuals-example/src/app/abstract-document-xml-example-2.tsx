...
export function AbstractDocumentXMLExample2(): React.JSX.Element {
  ...
  const [template, setTemplate] = React.useState(`<AbstractDoc>
    <StyleNames>
        <StyleName name="bold" type="TextStyle" bold="true" />
    </StyleNames>
    <Section>
      <TextParagraph text="Hello1 asd asd asd as das das das ddsa asdsa sdds ds  as sd asd dsd sads  sda ds ds as sas ads ad asdasd asd sda sdasad  sads adsad sasads ds ds ds dasad sa dsda sad sad  sads ads adsad sda sadsd asda sda sdasda asd  asd sad sdadsa sadsa dsa " styleNames="bold" />
      <TextParagraph text="Hello2" />
    </Section>
  </AbstractDoc>`);
