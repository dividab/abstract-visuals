...
export const ImageNamespace = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/image.js";
export const RelationNamespace = "http://schemas.openxmlformats.org/package/2006/relationships";
export const NumberingNamespace = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/numbering.js";

export const DocumentPath = "word\\";
export const RefPath = "_rels\\";
export const ImagePath = "media\\";
export const ContentTypesPath = "";
export const NumberingPath = "word\\";

export const HeaderContentType = "application/vnd.openxmlformats-officedocument.wordprocessingml.header+xml";
export const MainContentType = "application/vnd.openxmlformats-officedocument.wordprocessingml.document.main+xml";
export const RelationContentType = "application/vnd.openxmlformats-package.relationships+xml";
export const NumberingContentType = "application/vnd.openxmlformats-officedocument.wordprocessingml.numbering+xml";
