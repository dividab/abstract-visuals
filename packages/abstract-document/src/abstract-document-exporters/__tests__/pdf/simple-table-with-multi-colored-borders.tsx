...
const cellstyle = TableCellStyle.create({
  ...
  borderColors: LayoutFoundationColor.create({ top: "red", left: "green", right: "blue", bottom: "yellow" }),
  background: "blue",
  padding: { left: 2, right: 2, top: 2, bottom: 2 },
});

export const testSimpleTableWIthMultiColoredBorders: ExportTestDef = {
  name: "Simple table with multi colored borders",
  abstractDocJsx: (
    <AbstractDoc>
      <Section>
