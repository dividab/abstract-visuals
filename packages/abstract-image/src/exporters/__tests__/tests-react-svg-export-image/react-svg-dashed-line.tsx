...
export const testReactSvgDashedLine: ExportTestDef = {
  ...
  expectedSerializedJsx:
    '{"key":null,"ref":null,"props":{"image":{"topLeft":{"x":0,"y":0},"size":{"width":400,"height":400},"backgroundColor":{"a":255,"r":255,"g":255,"b":255},"components":[{"type":"line","start":{"x":10,"y":100},"end":{"x":40,"y":70},"strokeColor":{"a":255,"r":0,"g":0,"b":0},"strokeThickness":2,"strokeDashStyle":{"dashes":[10,5],"offset":3}}]}},"_owner":null,"_store":{}}',
};
