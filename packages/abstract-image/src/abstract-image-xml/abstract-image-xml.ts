...
import { xsd } from "../abstract-image/abstract-image-xsd.js";
...
export const abstractSheetXml = (template: string, data: any): AbstractSheet =>
  abstractSheetOfXml(parseHandlebarsXml(template, data)[0]!) as AbstractSheet;
...
export function abstractSheetOfXml(el: XmlElement): unknown {
  ...
  switch (el.tagName) {
    case "AbstractImage":
      ...
      return { backgroundColor } satisfies AbstractImage;
    case "BinaryImage": {
